...
export class ProgressComponent
  ...
  public setIndex(targetIndex: number): void {
    if (targetIndex >= 0 && targetIndex < this.itemLength) {
        if (this.activeIndex === targetIndex) {
            return;
        }
        
        // Eliminar clase activa del paso actual
        this.removeActiveStep();
        
        // Usar `setTimeout` para forzar actualización de DOM
        setTimeout(() => {
